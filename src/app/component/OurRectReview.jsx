...
const OurRectReview = () => {
  ...
  return (
      ...
      <section className={style.OurRecentReview}>
        <div className="flex flex-col md:flex-row text-black relative p-5">
            ...
            <div className="mt-16">
              ...
              <div className="md:flex md:flex-row">
                ...
                <div className="md:w-2/5 p-5">
                  ...
                  <div className={`card ${style.ourRecentCard} md:w-80`}>
...
<div className={`card ${style.ourRecentCard} md:w-80 md:ml-16`}>
  <div className="card-header md:flex md:mt-2 md:ml-6">
  ...
  <div className="card-body">
    ...
    <p className="card-text md:text-sm">
      ...
      quisque porta iaculis scelerisque
          ...
          <div className="md:w-5/12 md:absolute md:top-44 md:right-0 ">
